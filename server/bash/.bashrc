...
alias nb='jupyter notebook --port=8096 --ip=0.0.0.0 --no-browser --notebook-dir=${HOME}/code'
alias lab='jupyter lab --port=8096 --ip=0.0.0.0 --no-browser --notebook-dir=${HOME}/code'
