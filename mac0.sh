...
ln -s "${HOME}/Documents/config/dotfiles/scripts/launchd/backups.plist" "${HOME}/Library/LaunchAgents"
ln -s "${HOME}/Documents/config/dotfiles/scripts/launchd/backup-local.plist" "${HOME}/Library/LaunchAgents"
